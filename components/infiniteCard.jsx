...
export function InfiniteMovingCardsDemo() {
  return (
    (<div
      className="h-[10rem] md:h-[15rem] rounded-md flex flex-col antialiased bg-transparent dark:bg-transparent items-center justify-center relative overflow-hidden">
