        ...
        <div style={{ overflow: 'hidden', height: '100vh' }} className="relative min-h-screen bg-black flex p-4">  
            ...
            {typeof window !== 'undefined' && window.innerWidth > 768 && (  
                <button  
                    ...
                    className={`absolute top-1/2 transform -translate-y-1/2 p-2 text-white rounded-full shadow-md transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'left-[240px]' : 'left-4'} ${window.innerWidth <= 768 ? 'w-full' : ''}`}  
                >  
